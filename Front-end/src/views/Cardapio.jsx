          ...
          <div className="fixed inset-0 flex items-center justify-center">
            ...
            <div className="relative bg-white p-8 rounded-lg text-center md:w-96 lg:w-96 md:mx-auto lg:mx-auto mt-8 z-10">
              ...
              <div className="flex justify-center mt-6">
                <button className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded mr-2" onClick={handleCompraClick}>
                  Comprar
                </button>
                <button className="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded" onClick={handleCloseModal}>
                  Fechar
                </button>
              </div>
            </div>
